...
public class VinaphoneCDR {
	...
	public static VinaphoneCDR createCDRFromFileString(String cdrContent) {
		...
		try {
			cdr.setStreamNo(Integer.parseInt(contentElements[0]));
			cdr.setMsgId(contentElements[1]);
			cdr.setCpName(contentElements[2]);
			cdr.setSpId(contentElements[3]);
			cdr.setServiceId(contentElements[4]);
			cdr.setServiceName(contentElements[5]);
			cdr.setProductId(contentElements[6]);
			cdr.setContentName(contentElements[7]);
			cdr.setSubContentName(contentElements[8]);
			cdr.setPlayType(contentElements[9]);
			cdr.setAccessChannel(Integer.parseInt(contentElements[10]));
			cdr.setTime_stamp(contentElements[11]);
			cdr.setPkgSpId(contentElements[12]);
			cdr.setPkgServiceId(contentElements[13]);
			cdr.setPkgProductId(contentElements[14]);
			cdr.setContentId(contentElements[15]);
			cdr.setMsisdn(contentElements[16]);
			cdr.setOriginalfee(Integer.parseInt(contentElements[17]));
			cdr.setFee(Integer.parseInt(contentElements[18]));
			cdr.setPayType(Integer.parseInt(contentElements[19]));
			cdr.setReason(contentElements[20]);
			cdr.setChargeType(Integer.parseInt(contentElements[21]));
			cdr.setChargeResult(Integer.parseInt(contentElements[22]));
			cdr.setRecNum(Integer.parseInt(contentElements[23]));
		} catch (Exception e) {
			e.printStackTrace();
		}
		return cdr;
