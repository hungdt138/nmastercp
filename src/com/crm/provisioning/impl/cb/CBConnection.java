...
public class CBConnection extends ProvisioningConnection {
	...
	public double getSubscriberStatus(String schema, String isdn, int contCode) throws TreChainedException
	{
		String status_code = "";
		if (contCode == 102) 
		{
		...
		else if (contCode == 103)
		{
			status_code = "(3,211,2002) ";
		}
		...
		String strCommand = 
			...
			" and a.service_status_code in " + status_code + // ( active or bared 1 way)
