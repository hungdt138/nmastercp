...
import com.comverse_in.prepaid.ccws.ArrayOfCallHistory;
...
import com.comverse_in.prepaid.ccws.ArrayOfMonetaryTransactionRecord;
...
public class CCWSConnection extends ProvisioningConnection
{
	 ...
	 * @throws Exception
	 */
	public SubscriberRetrieve getSubscriberRetrieve(String isdn, int queryLevel) throws Exception
	{
	...
	public ServiceSoapStub loadService() throws Exception
	{
		...
		try
		{
			try
			{
				...
				PasswordCallback pwCallback = new PasswordCallback(getPassword());
	...
	public static void main(String[] arr)
	{
		...
		strPassword = "nms!23";
		// Test
		CCWSConnection k = new CCWSConnection();
	}
}
