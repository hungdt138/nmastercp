			...
			if (dispatcher.localCallback)
			{
				try
				{
					synchronized (request)
					{
						...
						if (debit)
						{
							changeCoreBalance(httpClient,httpPost, chargingSession, "directDebitAmount", dispatcher.currency, amount);
						}
						else
						{
							changeCoreBalance(httpClient, httpPost, chargingSession, "directCreditAmount", dispatcher.currency, amount);
						}
