...
/**
 * GetPushMessageDeliveryStatus.java
 *
 ...
 */
            ...
            /**
            *  GetPushMessageDeliveryStatus bean class
            */
        
        public  class GetPushMessageDeliveryStatus
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = getPushMessageDeliveryStatus
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       GetPushMessageDeliveryStatus.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getPushMessageDeliveryStatus",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
    ...
    public static class Factory{
        ...
        */
        public static GetPushMessageDeliveryStatus parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetPushMessageDeliveryStatus object =
                new GetPushMessageDeliveryStatus();
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getPushMessageDeliveryStatus".equals(type)){
                                ...
                                return (GetPushMessageDeliveryStatus)vinaphone.org.csapi.www.schema.parlayx.wap_push.send.v1_0.local.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.csapi.org/schema/parlayx/wap_push/send/v1_0/local","requestIdentifier").equals(reader.getName())){
