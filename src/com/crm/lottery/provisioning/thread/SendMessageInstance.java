...
public class SendMessageInstance extends DispatcherInstance
{

	public SendMessageInstance() throws Exception
	{
		super();
	...
	@Override
	public SendMessageThread getDispatcher()
	{
		// TODO Auto-generated method stub
		return (SendMessageThread) super.getDispatcher();
	}
	...
	public int processMessage(QueueSession session, MessageProducer producer, Object request) throws Exception
	{
		...
		if (request instanceof CommandMessage)
		{
			...
			try
			{
				String debugContent = "SEND SUBS: ISDN=" + msg.getIsdn() + ",CODE="
						+ msg.getRequestValue("lottery.regionCode", "");
