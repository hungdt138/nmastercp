...
public class CommandMessage extends BaseMessage
{
	...
	private String				vnmproduct			= "";

	// DuyMB add GO service 20140402
	private String				nextQuestion		= "";

	// DuyMB add scenario type for vasgate.
	private long				scenarioType		= 0;
	...
	public void copyTo(CommandMessage destination)
	{
		...
		// DuyMB add scenario type for vasgate 20140317
		destination.setScenarioType(scenarioType);
		// Duymb add GO services 20140402
		destination.setNextQuestion(nextQuestion);
	...
	public String toString()
	{
		...
		result.append(" | cgw_status = ");
		result.append(cgwStatus);

		// DuyMB add sceanario type for vasgate 20130317
	...
	public String getVnmproduct()
	{
		return vnmproduct;
	}

	public void setVnmproduct(String vnmproduct)
	{
		this.vnmproduct = vnmproduct;
	}
	...
	public long getScenarioType()
	{
		return scenarioType;
	}

	public void setScenarioType(long scenarioType)
	{
