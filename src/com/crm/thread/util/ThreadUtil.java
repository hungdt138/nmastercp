...
public class ThreadUtil
{
	...
	public static ConcurrentHashMap<String, MonitorMessage>	threadLogs				= new ConcurrentHashMap<String, MonitorMessage>();
	...
	public static Vector createInstanceParameter(ManageableThread thread)
	{
		...
		// vtReturn.addElement(createBooleanParameter("neverExpire",
		// "never end of session"));
