...
public class SimulatorThread extends DispatcherThread
{
	...
	public Vector getSimulatorDefinition()
	{
		...
		vtReturn.addElement(ThreadUtil.createTextParameter("content", 500, ""));
		vtReturn.addElement(ThreadUtil.createTextParameter("queueResponse", 100, ""));
	...
	public void fillSimulatorParameter() throws AppException
	{
		try
		{
			...
			content = ThreadUtil.getString(this, "content", false, "");
			queueResponse = ThreadUtil.getString(this, "queueResponse", false, "");
